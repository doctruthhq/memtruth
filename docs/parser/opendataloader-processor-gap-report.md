...
`doctruth-java-core-20260628T203300Z/full200` is the latest recorded
Java-core plus Rust MNN auto-routing run. It parsed 200/200 documents in
`20687.818542` ms, with a mean `103.439093` ms/doc, no failures, no
...
steps. Full200 MHS rose from `0.495476` to `0.532954`, MHS_s rose from
`0.637201` to `0.665893`, and overall rose from `0.795795` to `0.804633` while
