...
- Artifacts:
  `third_party/opendataloader-bench/prediction/doctruth-java-core-phase18-area-competence-full200/full200/`
...
- Overall mean: `0.764969`
- NID mean: `0.891060`
- TEDS mean: `0.597754`
- MHS mean: `0.485718`
- Resource: mean `74.627939` ms/doc, process RSS peak `20MB`, no
