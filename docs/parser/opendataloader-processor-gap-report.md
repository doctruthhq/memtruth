...
`doctruth-java-core-phase18-area-competence-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `14925.587709` ms, with
a mean `74.627939` ms/doc, lazy model startup enabled, process RSS peak `20MB`,
