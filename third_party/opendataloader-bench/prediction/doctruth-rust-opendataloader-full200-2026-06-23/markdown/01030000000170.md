cropping.
P Value, RGMM 0.30 0.25 0.25 0.30 0.35 0.40 Contour Strip Cropping P Value, RRGM 0.45 0.38 0.38 0.45 0.52 0.60 Table adapted from Jones et al. (1988) with permission. †Strip cropping uses a four-year rotation of row crop followed by one year of a small grain and two years of meadow (forages) for RGMM, or uses two years of row crops followed by one year of small grain and one year of meadow for RRGM. Meadow includes alfalfa, clover, grass, etc.
...
| |Terrace Interval|Underground Outlets|W|aterways with percent grade of:| |
|---|---|---|---|---|---|
