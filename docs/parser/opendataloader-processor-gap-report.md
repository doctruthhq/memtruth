...
`doctruth-java-core-phase23-arrow-flow-full200/full200` is the latest recorded
Java-core run. It parsed 200/200 documents in `15240.375` ms, with a mean
`76.201875` ms/doc, lazy model startup enabled, process RSS peak `20MB`,
