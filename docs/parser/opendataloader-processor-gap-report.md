...
`doctruth-java-core-phase22-training-datasets-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `15365.875458` ms, with
a mean `76.829377` ms/doc, lazy model startup enabled, process RSS peak `20MB`,
