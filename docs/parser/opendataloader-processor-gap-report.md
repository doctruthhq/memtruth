...
`doctruth-java-core-phase26-national-initiatives-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `15224.416667` ms, with
a mean `76.122083` ms/doc, lazy model startup enabled, process RSS peak `20MB`,
