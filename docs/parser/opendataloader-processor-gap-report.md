...
`doctruth-java-core-20260628T220700Z/full200` is the latest recorded
Java-core plus Rust MNN auto-routing run. It parsed 200/200 documents in
`17083.819917` ms, with a mean `85.419100` ms/doc, no failures, no
