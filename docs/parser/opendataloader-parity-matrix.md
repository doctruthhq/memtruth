...
- Artifacts:
  `third_party/opendataloader-bench/prediction/doctruth-java-core-phase24-blank-comparison-full200/full200/`
...
- Overall mean: `0.774497`
- NID mean: `0.893263`
- TEDS mean: `0.699752`
- MHS mean: `0.485275`
- Resource: mean `79.225799` ms/doc, process RSS peak `21MB`, no
