...
`doctruth-java-core-phase24-blank-comparison-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `15845.159875` ms, with
a mean `79.225799` ms/doc, lazy model startup enabled, process RSS peak `21MB`,
