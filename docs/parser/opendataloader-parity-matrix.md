...
- Artifacts:
  `third_party/opendataloader-bench/prediction/doctruth-java-core-phase22-training-datasets-full200/full200/`
...
- Overall mean: `0.770253`
- NID mean: `0.891972`
- TEDS mean: `0.657165`
- MHS mean: `0.485812`
- Resource: mean `76.829377` ms/doc, process RSS peak `20MB`, no
