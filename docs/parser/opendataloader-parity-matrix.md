...
- Artifacts:
  `third_party/opendataloader-bench/prediction/doctruth-java-core-phase23-arrow-flow-full200/full200/`
...
- Overall mean: `0.773042`
- NID mean: `0.892878`
- TEDS mean: `0.679411`
- MHS mean: `0.485812`
- Resource: mean `76.201875` ms/doc, process RSS peak `20MB`, no
