...
`doctruth-java-core-phase11-column-stream-table-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `15896.198792` ms, with
a mean `79.480994` ms/doc, lazy model startup enabled, and no
