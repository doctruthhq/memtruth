...
- Artifacts:
  `third_party/opendataloader-bench/prediction/doctruth-java-core-phase21-port-shipcalls-full200/full200/`
...
- Overall mean: `0.769130`
- NID mean: `0.891908`
- TEDS mean: `0.641616`
- MHS mean: `0.485740`
- Resource: mean `76.578184` ms/doc, process RSS peak `21MB`, no
