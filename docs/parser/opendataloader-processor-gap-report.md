...
`doctruth-java-core-phase25-eco-framework-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `16128.394792` ms, with
a mean `80.641974` ms/doc, lazy model startup enabled, process RSS peak `21MB`,
