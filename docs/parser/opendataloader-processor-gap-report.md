...
`doctruth-java-core-phase16-species-list-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `16794.993417` ms, with
a mean `83.974967` ms/doc, lazy model startup enabled, process RSS peak `21MB`,
