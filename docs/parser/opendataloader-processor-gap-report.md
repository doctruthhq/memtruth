...
`doctruth-java-core-phase17-excel-fragment-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `15458.87375` ms, with
a mean `77.294369` ms/doc, lazy model startup enabled, process RSS peak `20MB`,
