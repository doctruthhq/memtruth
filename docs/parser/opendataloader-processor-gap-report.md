...
`doctruth-java-core-phase20-cation-inline-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `15064.4725` ms, with
a mean `75.322363` ms/doc, lazy model startup enabled, process RSS peak `21MB`,
