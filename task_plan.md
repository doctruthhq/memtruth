...
| Long cross-row comparative table reconstruction | complete | OpenDataLoader fixture `01030000000088` now reconstructs the foreign-ownership comparative table as one `TrustTable` and benchmark Markdown table; single-doc result `overall=0.983416`, `teds=0.999827`, `nid=0.967004`. |
