...
`doctruth-java-core-phase21-port-shipcalls-full200/full200` is the latest
recorded Java-core run. It parsed 200/200 documents in `15315.636834` ms, with
a mean `76.578184` ms/doc, lazy model startup enabled, process RSS peak `21MB`,
